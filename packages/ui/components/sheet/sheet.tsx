...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-neutral-200 bg-white p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:border-neutral-700/50 dark:bg-neutral-950",
  {
    variants: {
      side: {
