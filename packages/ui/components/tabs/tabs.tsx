...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "bg-foreground inline-flex items-center justify-center rounded-xl p-[0.0625rem] dark:bg-[#262626]",
      className
    )}
    {...props}
  />
